...
<table border="0">
<tr>
<th colspan="5"><h2>Select the desired options:</h2></th>
</tr>
<tr>
<td>
<form action="Register.php">
<input type="submit" value="register">&nbsp&nbsp&nbsp
</form>
</td>
<td>
<form action="database2.php" >
<input type="submit" value="VIEW">&nbsp&nbsp&nbsp</form></td>
<td><form action="delete2.php" >
<input type="submit" value="DELETE">&nbsp&nbsp&nbsp</form></td>
<td>
...
<input type="submit" value="back">&nbsp&nbsp&nbsp
</form>
</form>
</td>
</tr>
