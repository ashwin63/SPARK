...
<table border="0" background="wall.jpg">
<tr>
<td rowspan="2" colspan="2" width="900px" style=" vertical-align: top"><img src="regi1.png" width="900px" height="500px"></td>
<td rowspan="2" colspan="2" width="400px">
<pre>

<form action="database.php" method="POST">

<b><font color="#000" size="4">
<input type="text" name="name" value="NAME" style="width: 300px; height: 40px"><br>

<input type="text" name="age" value="AGE"style="width: 300px; height: 40px" ><br>
...
<input type="text" name="dob" value="DOB" style="width: 300px; height: 40px"><br>

<input type="text" name="bloodgroup" value="BLOOD GROUP" style="width: 300px; height: 40px"><br>

<input type="text" name="occupation" value="OCCUPATION" style="width: 300px; height: 40px"><br>

<textarea rows="3" cols="20" name="residence" value="RESIDENCE">
RESIDENCE</textarea><br>

<input type="text" name="complaint" value="COMPLAINT" style="width: 300px; height: 40px"><br>

<input type="text" name="history_of_present_illness" value="HISTORY OF PRESENT ILLNESS" style="width: 300px; height: 40px"><br>

<input type="text" name="past_history_of_illness" VALUE="PAST HISTORY OF ILLNESS" style="width: 300px; height: 40px"><br>

<input type="text" name="family_history" value="FAMILY HISTORY" style="width: 300px; height: 40px"><br>

<input type="text" name="personal_history" value="PERSONAL HISTORY"style="width: 300px; height: 40px"><br>

<input type="text" name="drug_allergy" VALUE="DRUG ALLERGY" style="width: 300px; height: 40px"><br>

<input type="text" name="BP" value="BP" style="width: 300px; height: 40px"><br>

<input type="text" name="sugar_level" value="SUGAR LEVEL" style="width: 300px; height: 40px"><br>
<input type="text" name="pulse" value="PULSE" style="width: 300px; height: 40px"> 
<br>
...
<hr></b></b>
<h7><pre>
<b>Patient Care</b>            <b>Key Medical Procedures</b>                  <b>Education</b>            <b>Centres of Excellence</b>        <b>Research</b>
<i> 
...
Pay Online              Hand MicroSurgery                       Spark Med Skills      Gastroenterology            
                        ...
                        Minimally Invasive Cardiac Surgery</body>
